...
const timeOptions = [
  '12:00 PM', '1:00 PM', '2:00 PM', '7:00 PM', '8:00 PM', '9:00 PM', '10:00 PM'
]
const guestOptions = ['2 Guests', '4 Guests', '6 Guests', '8+ Guests']
const occasionOptions = [
  'Casual Dining', 'Birthday', 'Anniversary', 'Corporate', 'Date Night', 'Other'
]
      ...
      <div className="container-main">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
          ...
          <div className="w-full lg:w-[45%]">
            ...
            >
              Whether it&apos;s a romantic dinner, a celebration with friends, or a corporate
              gathering, we&apos;d love to host you. Reserve your table and let us craft an
              unforgettable experience.
            </p>

            <form onSubmit={handleSubmit} className="reserve-form mt-10 max-w-md space-y-5">
              ...
              <div className="reserve-field" style={{ opacity: 0 }}>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className={inputClass}
                  style={{ borderColor: 'rgba(255,255,255,0.15)', resize: 'vertical' }}
                />
              </div>
              ...
              {submitted && (
                <p className="text-coral text-sm text-center animate-pulse">
                  Your reservation request has been sent! We&apos;ll confirm shortly.
                </p>
              )}
            </form>
          </div>
