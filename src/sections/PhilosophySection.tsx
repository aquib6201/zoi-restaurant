      ...
      <div className="container-main">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-1/2">
            ...
            >
              At Zoi, we believe dining is more than sustenance — it&apos;s an
              experience that engages all senses. Our chefs source the finest
              ingredients, our bartenders craft cocktails with precision, and
              our space is designed to make every visit memorable. From intimate
              dinners to lively celebrations, Zoi is where Ranchi comes alive.
            </p>
